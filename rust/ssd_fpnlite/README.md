...
(docker)$ ./ssvm-tensorflow --dir .:. ssd_fpnlite.wasm frozen.pb dog_cat.jpg
```
...
(docker)$ cd /root/ssvm-tensorflow/build/tools
# Copy input image, model, and wasm file to /root/ssvm-tensorflow/build/tools
(docker)$ ./ssvmc-tensorflow ssd_fpnlite.wasm ssd_fpnlite.wasm.so
(docker)$ ./ssvm-tensorflow --dir .:. ssd_fpnlite.wasm.so frozen.pb dog_cat.jpg
```
