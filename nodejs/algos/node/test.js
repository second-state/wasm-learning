...
const fs = require('fs');
var iris_csv = fs.readFileSync("iris.csv");
var training_csv = fs.readFileSync("training.csv");
var training_svm_csv = fs.readFileSync("training_svm.csv");
var model;
