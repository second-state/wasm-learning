...
```
{"wasm_id":208,"wasm_sha256":"0x469c28daae7aba392076b4bc5ee3b43ec6d667083d8ae63207bf74b1da03fc26","SSVM_Usage_Key":"00000000-0000-0000-0000-000000000000","SSVM_Admin_Key":"7dxxxxxx-xxxx-xxxx-xxxx-xxxxxxxx0c41"}
```

Note: You can update this binary with the `SSVM_Admin_Key`.

```
$ curl --location --request PUT 'https://rpc.ssvm.secondstate.io:8081/api/update_wasm_binary/208' \
--header 'Content-Type: application/octet-stream' \
--header 'SSVM_Admin_Key: b2xxxxxx-xxxx-xxxx-xxxx-xxxxxxxx2331' \
--data-binary '@pkg/mobilenet_service_lib_bg.wasm'
```
...
```
$ curl --location --request POST 'https://rpc.ssvm.secondstate.io:8081/api/run/208/infer' \
--header 'Content-Type: application/octet-stream' \
--data-binary '@test/ladybug.jpg'
```
